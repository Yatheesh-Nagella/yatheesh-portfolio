      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">Budgets</h1>
            ...
            {budgets.map((budget) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Warning if over 80% */}
                  {percentage >= 80 && (
                    <div className={`flex items-center gap-2 text-sm ${percentage >= 100 ? 'text-red-600' : 'text-orange-600'}`}>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4 pt-4 border-t border-gray-100">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm font-medium flex items-center justify-end gap-1">
                        <TrendingUp className={`w-4 h-4 ${percentage > 50 ? 'text-red-500' : 'text-green-500'}`} />
